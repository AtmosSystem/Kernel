...
(defn is-valid-serializer-map?
  [serializer-map]
  (if (s/valid? ::serializer-map serializer-map) true (s/explain ::serializer-map serializer-map)))
...
(defn is-valid-de-serializer-map?
  [de-serializer-map]
  (if (s/valid? ::de-serializer-map de-serializer-map) true (s/explain ::de-serializer-map de-serializer-map)))
